 ...
 */
/**
 * Servlet para gestionar el login de usuarios. Este servlet maneja tanto el
 * inicio de sesión como el cierre de sesión (logout).
 */
...
public class GestionLogin extends HttpServlet {
	...
	/**
	 * Constructor de la clase {@link GestionLogin}. Este constructor invoca el
	 ...
	 * Si la petición es de logout, se invalida la sesión. Si es de login, se
	 * verifican las credenciales.
	 * 
	 * @param request  La solicitud HTTP del cliente.
	 * @param response La respuesta HTTP que se enviará al cliente.
	 * @throws ServletException Si ocurre un error al procesar la solicitud.
