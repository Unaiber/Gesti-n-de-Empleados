...
public class GestionUsuarios extends HttpServlet {
	...
	/**
	 * Constructor de la clase {@link GestionUsuarios}. Este constructor invoca el
	...
	/**
	 * Maneja las solicitudes GET para la gestión de usuarios. Actualmente no se
	...
	/**
	 * Maneja las solicitudes POST para la gestión de usuarios. Este método procesa
	 * los datos enviados desde un formulario para crear un nuevo usuario.
	 * 
	 * @param request  La solicitud HTTP del cliente.
	 * @param response La respuesta HTTP que se enviará al cliente.
	 * @throws ServletException Si ocurre un error al procesar la solicitud.
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// Si la acción es "crearUsuario", se inserta el nuevo usuario en la base de
			// datos
			...
			// En caso de error en la base de datos, se imprime el error y se redirige con
			// un mensaje de error
			e.printStackTrace();
