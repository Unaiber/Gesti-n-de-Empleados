...
/**
 * Clase de prueba que valida las operaciones CRUD sobre empleados en la base de
 * datos SQLite. Se utiliza una base de datos en memoria para realizar las
 * pruebas sin modificar datos persistentes.
 */
public class TestEmpleadosDAO_SQLite {
	...
	/**
	 * Configura la base de datos en memoria antes de cada prueba, creando las
	 * tablas y vistas necesarias. También se inicializa el DAO para las operaciones
	 * de empleados.
	 */
	@BeforeEach
	...
	/**
	 * Cierra la conexión a la base de datos después de cada prueba. Este método se
	...
	/**
	 * Prueba que verifica la inserción de un empleado y su lectura desde la base de
	 * datos. Se asegura de que el empleado insertado esté presente en la lista
	 * obtenida.
	 */
	@Test
	...
	/**
	 * Prueba que verifica la actualización de un empleado en la base de datos. Se
	 * inserta un empleado, se actualiza su nombre y se comprueba que el cambio fue
	 * exitoso.
	 */
	@Test
	...
	/**
	 * Prueba que verifica la eliminación de un empleado de la base de datos. Se
	 * inserta un empleado, se borra y se comprueba que el número de empleados
	 * eliminados sea 1.
	 */
	@Test
