...
/**
 * Filtro que verifica si el usuario está autenticado antes de acceder a ciertas páginas.
 * Si el usuario no tiene sesión activa o no está autenticado, se le redirige al login (index.html).
 */
...
public class FiltroAutenticacion implements Filter {
     ...
     * Verifica si el usuario tiene sesión activa. Si no tiene sesión o no está autenticado,
     * se redirige al login.
     *
     * @param request la solicitud HTTP recibida
     * @param response la respuesta HTTP que se enviará
     * @param chain la cadena de filtros que se debe ejecutar si el usuario está autenticado
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        // Si la sesión está activa y el usuario está autenticado, se permite continuar con la solicitud
