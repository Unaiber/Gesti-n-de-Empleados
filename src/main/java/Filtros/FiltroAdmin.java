...
/**
 * Filtro que garantiza que solo los usuarios con rol "ADMIN" puedan acceder a
 * la página de alta de usuarios. Si el usuario no está autenticado o no tiene
 * el rol adecuado, será redirigido a la página principal o al login.
 */
...
public class FiltroAdmin implements Filter {
	 ...
	 * Verifica si el usuario está autenticado y si tiene el rol de "ADMIN". Si no
	 * cumple alguna de estas condiciones, se redirige a la página principal con un
	 * mensaje de error o al login.
	 *
	 * @param request  la solicitud HTTP recibida
	 * @param response la respuesta HTTP que se enviará
	 * @param chain    la cadena de filtros que se debe ejecutar si el usuario está
	 *                 autenticado y tiene el rol adecuado
