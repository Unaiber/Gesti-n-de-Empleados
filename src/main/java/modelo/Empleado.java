...
/**
 * Clase que representa a un empleado en el sistema. Contiene los atributos
 * necesarios para almacenar información de un empleado y operaciones CRUD
 * asociadas con la base de datos a través de la clase EmpleadosDAO.
 */
public class Empleado {
	...
	/**
	 * Constructor con parámetros para crear un empleado nuevo. Utilizado en las
	 * operaciones de insertar y actualizar.
	 *
	 * @param nombre          el nombre del empleado
	 * @param email           el correo electrónico del empleado
	 * @param salario         el salario del empleado
	 * @param departamento_id el identificador del departamento al que pertenece el
	 *                        empleado
	 */
	...
	/**
	 * Constructor con parámetros para crear un empleado, utilizado para las
	 * operaciones de lectura y borrado de datos del empleado.
	 *
	...
	/**
	 * Inserta el empleado en la base de datos utilizando el DAO de Empleados. Llama
	 * al método insertar del DAO para realizar la operación de inserción.
	 *
	...
	/**
	 * Actualiza los datos del empleado en la base de datos utilizando el DAO de
	 * Empleados. Llama al método actualizar del DAO para realizar la operación de
	 * actualización.
	 *
	 * @throws SQLException si ocurre un error en la base de datos durante la
	 *                      actualización
	...
	/**
	 * Recibe un empleado de la base de datos y lo convierte a formato JSON
	 * utilizando Gson.
	 *
	...
	public String recibirEmpleados(int id) throws SQLException {
		...
		// Asigna los valores del empleado obtenido a los atributos de la instancia
		// actual
		this.id = e.getId();
