...
/**
 * Clase DAO para realizar operaciones con la tabla 'usuarios' en la base de
 * datos. Proporciona métodos para autenticar usuarios, insertar nuevos usuarios
...
public class UsuariosDAO {
	 ...
	 * "factory method" para crear una nueva instancia de UsuariosDAO.
	 * 
	...
	/**
	 * Autentica un usuario por su nombre de usuario y contraseña. Realiza una
	 * consulta a la base de datos para comprobar las credenciales del usuario. La
	 * contraseña almacenada en la base de datos se compara con la proporcionada
	 * utilizando BCrypt.
	 * 
	...
	/**
	 * Inserta un nuevo usuario en la base de datos. La contraseña proporcionada es
	 * encriptada utilizando BCrypt antes de ser insertada.
	 * 
