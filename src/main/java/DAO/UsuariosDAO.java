...
//Clase DAO para realizar operaciones con la tabla 'usuarios'
public class UsuariosDAO {
	
	// Conexión compartida (estática) a la base de datos
	public static Connection con;

	// Constructor: obtiene una conexión desde DatabaseConnection
	public UsuariosDAO () throws SQLException {
		UsuariosDAO.con = DatabaseConnection.getConnection();
	}
	
	// Método estático que devuelve una nueva instancia del DAO (similar a un "factory method")
	public static UsuariosDAO getConection () throws SQLException {
		UsuariosDAO ud = new UsuariosDAO();
		return ud;
	}
	
	// Método que autentica un usuario por su username y password
