...
/**
 * Clase DAO para realizar operaciones CRUD sobre la tabla 'empleados' en la base de datos.
 * Proporciona métodos para insertar, actualizar, eliminar, obtener empleados y convertir datos a formato JSON.
 */
public class EmpleadosDAO {
     ...
     * Funciona como un "factory method" para crear una nueva instancia de EmpleadosDAO.
     * 
    ...
    /**
     * Nuevo constructor para pruebas con una conexión personalizada (por ejemplo, SQLite).
     * 
     ...
     * @throws SQLException si ocurre un error al recuperar los empleados desde la base de datos
     */
    ...
    /**
     * Obtiene un empleado de la base de datos por su ID desde la vista 'vista_empleado'.
     * 
